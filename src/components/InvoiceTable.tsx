                ...
                <tbody>
                  ...
                  {/* 
                      <tr>
                        <td>
                          Sub Total <br />
                          <span style={{ color: '#666', fontSize: '10px' }}>(Tax Inclusive)</span>
                        </td>
                        <td style={{ padding: '0px 10px 16px 5px' }}>2,190.00</td>
                      </tr> 
                    */}
                  ...
                  {/* 
                      <tr>
                        <td>
                          Payment Made <br />
                          <span style={{ color: 'red', fontSize: '10px' }}>(Tax Inclusive)</span>
                        </td>
                        <td style={{ padding: '0px 10px 16px 5px' }}>(-) 2,190.0</td>
                      </tr> 
                    */}
